...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		JLabel lblAdminSection = new JLabel("Select Option");
		...
		JButton btnViewLibrarian = new JButton("View Student List");
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addComponent(lblAdminSection, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)
					.addGap(11)
